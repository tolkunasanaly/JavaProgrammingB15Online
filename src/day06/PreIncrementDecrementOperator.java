...
public class PreIncrementDecrementOperator {
    ...
    public static void main(String[] args) {
        ...
        //initializing (giving value) offerCount value 2
        int offerCount = 2;
       ...
       offerCount +=1;
        ...
        //There is even more shorter shortcut for this operation
        //and we use ++ or --, THIS IS EXCLUSIVELY FOR INCREASING OR DECREASING BY 1
        //We can NOT use it for any other type like increasing or decreasing value by more than one
        ...
        System.out.println("Offer Now decreased by one " + offerCount);
